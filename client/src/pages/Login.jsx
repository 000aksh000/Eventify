...
import { HiEnvelope, HiLockClosed, HiShieldCheck, HiSparkles, HiExclamationTriangle, HiCheckCircle } from 'react-icons/hi2';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.needsVerification) {
                setShowOTP(true);
                setSuccessMsg('Account pending verification. An OTP has been sent to your email.');
            } else {
        ...
        <div className="max-w-md mx-auto my-12">
            <div className="neu-flat-lg p-8 sm:p-10 rounded-3xl space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <h2 className="text-2xl font-black text-[#25272a] tracking-tight">Welcome Back</h2>
                    <p className="text-xs font-semibold text-slate-500">Sign in to your Eventify account</p>
                </div>
                ...
                <div className="pt-4 border-t border-slate-300/40 text-center text-xs font-semibold text-slate-500">
                    ...
                    <Link to="/register" className="text-slate-800 font-extrabold hover:underline">
                        Create an account
                    </Link>
                </div>
            </div>
