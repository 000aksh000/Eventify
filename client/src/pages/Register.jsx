...
import { HiUser, HiEnvelope, HiLockClosed, HiShieldCheck, HiSparkles, HiExclamationTriangle, HiCheckCircle } from 'react-icons/hi2';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!showOTP) {
                ...
                setShowOTP(true);
                setSuccessMsg(data.message || 'OTP sent to your email. Please verify to activate your account.');
            } else {
        ...
        <div className="max-w-md mx-auto my-12">
            <div className="neu-flat-lg p-8 sm:p-10 rounded-3xl space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <h2 className="text-2xl font-black text-[#25272a] tracking-tight">Create an Account</h2>
                    <p className="text-xs font-semibold text-slate-500">Join Eventify today</p>
                </div>
                ...
                <div className="pt-4 border-t border-slate-300/40 text-center text-xs font-semibold text-slate-500">
                    Already registered?{' '}
                    <Link to="/login" className="text-slate-800 font-extrabold hover:underline">
                        Sign in instead
                    </Link>
                </div>
            </div>
