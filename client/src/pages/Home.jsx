    ...
    <div className="flex flex-col min-h-screen py-8 space-y-12">
      ...
      <section className="neu-flat-lg rounded-3xl p-8 md:p-14 text-[#25272a] text-center flex flex-col items-center">
        ...
        <p className="text-slate-600 text-sm md:text-base mb-8 max-w-lg font-medium leading-relaxed">
          Explore handpicked technology retreats, workshops, and exclusive
          conferences happening around you.
        </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="neu-flat p-7 rounded-2xl flex flex-col items-start space-y-4">
          ...
          <p className="text-slate-600 text-xs leading-relaxed font-medium">
            Secure seats smoothly with real-time verification and automated
        ...
        <div className="neu-flat p-7 rounded-2xl flex flex-col items-start space-y-4">
          ...
          <p className="text-slate-600 text-xs leading-relaxed font-medium">
            Access, view, or manage your event ticket requests anytime directly
            from your dashboard.
          </p>
        </div>
        ...
        <div className="neu-flat p-7 rounded-2xl flex flex-col items-start space-y-4">
          ...
          <p className="text-slate-600 text-xs leading-relaxed font-medium">
            Every transaction and registration is protected with standard email
            OTP verification.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between border-b border-slate-300/40 pb-4">
          <div className="flex items-center gap-3">
            <h2 className="text-xl font-bold text-[#25272a] tracking-tight">
              Upcoming Events
            </h2>
        ...
        {loading ? (
          ...
          <div className="neu-flat rounded-2xl p-12 text-center text-slate-600 font-medium text-sm">
            No events match your search terms. Try searching for a different
            keyword.
          </div>
        ) : (
